...
export default function Home() {
  return (
    <div className="flex flex-col flex-1 items-center justify-start md:justify-center px-4 pt-4 pb-10 md:pt-[38px] md:pb-16 text-center gap-6 md:gap-8">
      <h1 className="text-[clamp(1rem,4.5vw,1.5rem)] md:text-[1.8rem] font-black uppercase tracking-[2px] whitespace-nowrap">
